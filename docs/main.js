...
const AUTH_API = 'https://roberto-291814.ew.r.appspot.com/api/auth/';
const httpOptions = {
...
const API_URL = 'https://roberto-291814.ew.r.appspot.com/api/test/';
class UserService {
    constructor(http) {
        this.http = http;
    }
...
module.exports = __webpack_require__(/*! C:\Users\User\Desktop\projects\robertoFE\src\main.ts */"./src/main.ts");
